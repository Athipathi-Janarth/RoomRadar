...
class BookingListViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "BookingUserViewCell", for: indexPath) as! BookingUserViewCell
        ...
        cell.HostName.text = bookingList.getBookings()[indexPath.row].Host.name
    ...
    func getBookings(forUserID userID: String){
        ...
        let query = bookingsRef.whereField("UserID", isEqualTo: userID)
